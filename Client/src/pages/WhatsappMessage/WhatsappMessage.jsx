...
const WhatsAppMessage = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_SERVER_URL}/whatsappMessage/sendWhatsapp`,
        {
          eventDetail,
          message,
        }
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_SERVER_URL}/upload/excelFile`,
        formData,
    ...
    <>
      <div className="flex ">
        ...
        <div className="flex flex-col gap-6 p-6 w-full ml-[120px]">
          <h2 className="text-center font-bold text-4xl">WhatsApp Messaging</h2>
          <div className="w-full flex flex-row gap-12 bg-white shadow-md rounded-lg p-6">
            ...
            <div className="w-full bg-white shadow-md rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                <strong>
                  (Event details required only while sending messages)
                </strong>
              </p>
              <form>
                <div className="mb-4">
            ...
            <div className="w-full bg-white shadow-md rounded-lg p-6">
              ...
              <p className="mt-4 text-gray-600 text-sm">
                <strong>Note:</strong> Upload file only in Excel format.
              </p>
            </div>
          </div>
          ...
          <div className="w-full bg-white shadow-md rounded-lg p-6 mt-6">
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              Write WhatsApp Message <span className="text-red-500">*</span>
            </h3>
            <p className="text-sm text-gray-600 mb-4">
              <strong>(Required only while sending WhatsApp messages)</strong>
            </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-2">
                <li>
                  <span className="font-medium">Bold:</span> Enclose text with *
                  (e.g., *bold text*)
                </li>
                <li>
                  <span className="font-medium">Italic:</span> Enclose text with
                  _ (e.g., _italic text_)
                </li>
                <li>
                  <span className="font-medium">Strikethrough:</span> Enclose
                  text with ~ (e.g., ~strikethrough text~)
                </li>
                <li>
                  <span className="font-medium">New Lines:</span> Press Enter to
                  add a new line
                </li>
              </ul>
            </div>
